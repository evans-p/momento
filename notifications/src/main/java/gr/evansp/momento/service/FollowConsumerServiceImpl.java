...
public class FollowConsumerServiceImpl implements FollowConsumerService {
    ...
    @Override
    public void consumeUserFollow(@Payload UserFollowAvro follow,
        ...
        log.info("Received Kafka message - partition: {}, offset: {}, key: {}, timestamp: {}",
                partition, offset, key, timestamp);

        try {
            acknowledgment.acknowledge();
        } catch (Exception e) {
            log.error("Error processing event from partition {} at offset {}: {}",
