...
class TestFileNameValidator extends AbstractUnitTest {
  ...
  public void testIsValid_ok() {
    try (ValidatorFactory factory = Validation.buildDefaultValidatorFactory()) {
      ...
      FileNameWrapper wrapper =
          new FileNameWrapper("10283bb6-8664-474d-9240-2036b59b4ece-f1e8af53.jpg");
  ...
  public void testIsValid_ok2() {
    try (ValidatorFactory factory = Validation.buildDefaultValidatorFactory()) {
      ...
      FileNameWrapper wrapper =
          new FileNameWrapper("10283bb6-8664-474d-9240-2036b59b4ece-f1e8af53.jpeg");
  ...
  public void testIsValid_ok3() {
    try (ValidatorFactory factory = Validation.buildDefaultValidatorFactory()) {
      ...
      FileNameWrapper wrapper =
          new FileNameWrapper("10283bb6-8664-474d-9240-2036b59b4ece-f1e8af53.png");
  ...
  private static class FileNameWrapper {
    ...
    @ValidFileName private String fileName;
