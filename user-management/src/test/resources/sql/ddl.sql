...
ALTER TABLE USER_MANAGEMENT.USER_PROFILE ADD CONSTRAINT FOLLOWED_COUNT_GREATER_EQUALS_ZERO CHECK(FOLLOWED_COUNT >= 0);
...
ALTER TABLE USER_MANAGEMENT.USER_FOLLOW ADD CONSTRAINT FK_FOLLOWED_ID FOREIGN KEY(FOLLOWED_ID) REFERENCES USER_MANAGEMENT.USER_PROFILE(ID);
ALTER TABLE USER_MANAGEMENT.USER_FOLLOW ADD CONSTRAINT FOLLOWS_ID_FOLLOWED_ID_UNIQUE UNIQUE(FOLLOWS_ID, FOLLOWED_ID);
